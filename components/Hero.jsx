    ...
    <section className='py-12 xl:py-24 h-[84vh] xl:pt-28 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none'>
        <div className="container mx-auto">
            <div className='flex justify-between gap-x-8'>
                ...
                <h1 className='h1 mb-6'>Hello, my name is Clavino Rachmadi</h1>
                <p className='subtitle max-w-[490px] mx-auto xl:mx-0'>Passionate Computer Science student at Mercu Buana University, aspiring to become a Software Engineer. Exploring Software Engineer with dedication and eagerness to learn.</p>
                {/* buttons */}
